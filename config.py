...
bot_token = 'OTcyMTMyNTE2NjU4MDIwMzYy.YnUm9Q.mj4DSMdwlzqEWLEcLpYdsfPo37c' #OLD!

# ID for channel where the bot will send audit logs
audit_log_channel_id = 992335921640910848

# ID for channel where the bot will send message logs
message_log_channel_id = 992335921640910848

# ID for channel where the bot will send voice logs
voice_chat_log_channel_id = 992335921640910848
